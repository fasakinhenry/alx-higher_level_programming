...
For this project, we expect you to look at the following Python programming concepts:

1. [The Python Tutorial](https://docs.python.org/3/tutorial/)
2. [Derek Banas’ Learn to Program](https://www.youtube.com/playlist?list=PLGLfVvz_LVvTn3cK5e6LjhgGiSeVlIRwt)
3. [The Python Guru](https://thepythonguru.com/)
4. [New String Formatting](https://realpython.com/python-f-strings/)
5. [Garbage Collector in Python](https://realpython.com/python-garbage-collection/)
6. [Python Interpreter](https://docs.python.org/3/tutorial/interpreter.html)
7. [Python Bytecode](https://realpython.com/cpython-source-code-guide/#python-bytecode)

![Not sure if C has taught me to be a programmer](./assets/0-python.jpg)
...
- [Whetting your Apetite](https://docs.python.org/3/tutorial/appetite.html)
...
- [Learn to Program- Youtbe playlist](https://www.youtube.com/playlist?list=PLGLfVvz_LVvTn3cK5e6LjhgGiSeVlIRwt)
